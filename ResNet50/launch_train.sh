...
python train_resnet50.py --test_every_n_steps=${test_every_n_steps} --batch_size=${batch_size} --train_database="$input_data_folder/$train_lmdb_file" --test_database="$input_data_folder/$test_lmdb_file" --output_dir="$input_data_folder" --number_classes=${number_classes} --learning_rate=${learning_rate}  --use_augmentation=${use_augmentation} --balance_classes=${balance_classes}
